...
const API_BASE = 'https://bible-api.deno.dev/api/read/dhh/daniel';
...
async function fetchAllDanielData() {
  console.log('🔄 Obteniendo datos del libro de Daniel (DHH)...');
  
  const danielBook = {
    book: 'Daniel',
    version: 'dhh',
    versionName: 'Dios Habla Hoy',
  ...
  fs.writeFileSync('./src/data/daniel-book-dhh.json', jsonData, 'utf8');
  
  console.log('✅ Datos guardados en src/data/daniel-book-dhh.json');
