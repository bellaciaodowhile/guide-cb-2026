...
const API_BASE = 'https://bible-api.deno.dev/api/read/nvi/daniel';
...
async function fetchAllDanielData() {
  console.log('🔄 Obteniendo datos del libro de Daniel (NVI)...');
  
  const danielBook = {
    book: 'Daniel',
    version: 'nvi',
    versionName: 'Nueva Versión Internacional',
  ...
  fs.writeFileSync('./src/data/daniel-book-nvi.json', jsonData, 'utf8');
  
  console.log('✅ Datos guardados en src/data/daniel-book-nvi.json');
