...
import { ArrowLeft, Book, AlertTriangle, Award } from 'lucide-react';
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        {loading ? (
          ...
          <div className="space-y-8">
            ...
            {/* Hero Section */}
            <div className="text-center py-12 bg-gradient-to-r from-green-50 to-emerald-50 dark:from-green-900/20 dark:to-emerald-900/20 rounded-2xl border border-green-200 dark:border-green-800">
              <h2 className="text-4xl font-bold text-gray-900 dark:text-white mb-4">
                Conquistadores: Narrativa Completa
              </h2>
              <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto leading-relaxed">
                Estudia la primera parte completa del libro de Daniel (capítulos 1-6). 
                Descubre todas las historias de fidelidad, milagros y la providencia divina 
