    ...
    <div className="max-w-4xl mx-auto animate-fade-in">
      ...
      <div className="mb-4 md:mb-8">
        <div className="flex items-center justify-between mb-6">
          <button
            onClick={onBack}
            className="flex items-center space-x-2 hover:opacity-80 transition-colors duration-200"
        ...
        <div 
          className="rounded-xl shadow-sm border p-6 mb-0 md:mb-4 animate-slide-up"
          style={{
       ...
       {/* Botón para ir al capítulo bíblico */}
        <div 
          className="rounded-xl p-6 border mb-4 animate-slide-up transition-colors duration-300" 
          style={{ 
        ...
        >
          ...
          <Link
            ...
            className="w-full sm:w-auto px-6 py-3 rounded-lg font-medium transition-all duration-300 flex items-center justify-center space-x-2 hover:opacity-90 transform hover:scale-105"
            style={{
          ...
          <div className="prose prose-lg dark:prose-invert max-w-none">
            {chapter.paragraphs.map((paragraph, index) => (
              <div
                ...
                style={{ 
                  backgroundColor: paragraph.hasQuote ? undefined : theme.styles.verseBackground,
              ...
              >
                ...
                <p 
                  ...
                  style={{ color: paragraph.hasQuote ? undefined : theme.styles.textColor }}
                >
                  {paragraph.text}
                </p>
              </div>
      ...
      <div className="mt-8 space-y-4">
        ...
        <div 
          className="hidden min-[750px]:block rounded-xl p-6 border transition-colors duration-300"
          style={{
            backgroundColor: theme.styles.verseBackground,
            borderColor: theme.styles.borderColor
          }}
