          ...
          <div className="space-y-4 md:space-y-8">
                ...
                {categories.map((category, index) => (
                  ...
                  >
                    ...
                    <div className={`relative w-full h-64 rounded-xl overflow-hidden shadow-lg ${
                      index === activeCardIndex ? 'shadow-2xl ring-2 ring-blue-500' : 'shadow-md hover:shadow-lg'
                    }`}>
                      {/* Imagen de fondo */}
                      <div 
            ...
            <div className="bg-[#fff] dark:bg-gray-800 rounded-xl shadow-sm animate-fade-in border">
              ...
              <div className={`overflow-hidden transition-all duration-500 ease-in-out ${
                isContentOpen ? 'max-h-96 opacity-100 transform translate-y-0' : 'max-h-0 opacity-0 transform -translate-y-2'
              }`}>
